...
export const generatedTools: GeneratedTool[] = [
  {
    ...
    "description": "Create an instant cluster (multiple pods with high-speed interconnect). BILLABLE from creation for every pod in the cluster: state the total hourly price before creating. Verify GPU stock first via the catalog tools; delete with delete-cluster when finished.",
    "method": "POST",
    "path": "/v2/clusters",
    "params": [],
    "hasBody": true,
  ...
  },
  {
    ...
    "description": "Create a network volume. Provisions a new network volume — persistent, network-attached storage that can be mounted into pods and serverless workers. Required inputs are `name`, `size` (in GB), and `dataCenter`; an optional `type` selects the storage tier and is immutable after creation. See `CreateNetworkVolumeRequest` for the size bounds and tier options. This creates a billable persistent resource that keeps incurring storage charges until it is deleted. Returns `201` with the created network volume, including its assigned `id`.",
    "method": "POST",
  ...
  },
  {
    ...
    "description": "Rent a GPU/CPU pod. BILLABLE from creation until stop/terminate: state the hourly price before creating. GPU selection is the gpu object: gpu.id takes a catalog GPU type id (e.g. \"NVIDIA GeForce RTX 4090\"), verified via list-gpu-types, and gpu.count sets the GPU count; cloud/data-center choice constrains stock.",
    "method": "POST",
    "path": "/v2/pods",
    "params": [],
    "hasBody": true,
  ...
  },
  {
    ...
    "description": "Create a container registry credential. Stores credentials for a private container registry. Credentials are write-only.",
    "method": "POST",
    "path": "/v2/registries",
    "params": [],
    "hasBody": true,
  ...
  },
  {
    ...
    "description": "Create a template. Creates a reusable container-configuration preset — image, disk, ports, env, registry, and mount settings — for pods and serverless endpoints. Pass its ID as `templateId` to `createPod` or `createEndpoint`, or spread its fields into the request body directly. Returns the created template.",
    "method": "POST",
    "path": "/v2/templates",
    "params": [],
    "hasBody": true,
  ...
  },
  {
    ...
    "description": "Delete a cluster. Permanently deletes a cluster and terminates all of its member pods.",
    "method": "DELETE",
    "path": "/v2/clusters/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "Delete a serverless endpoint permanently and immediately. Verify the id belongs to the intended endpoint (get-endpoint) before deleting; delete only endpoints your own tool calls created in this conversation — a name is not attribution.",
    "method": "DELETE",
  ...
  },
  {
    ...
    "description": "Delete a network volume. Permanently deletes a network volume and releases its storage.",
    "method": "DELETE",
  ...
  },
  {
    ...
    "description": "Terminate a pod permanently — its container disk is lost. Distinguish from stopping (pod-action stop) which releases the GPU but keeps volume data. Verify the id with get-pod first; terminate only pods your own tool calls created in this conversation — a name is not attribution.",
    "method": "DELETE",
    "path": "/v2/pods/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "Delete a container registry credential. Permanently deletes a container registry credential by ID. Rejected if any pod currently uses this credential to pull its image. Templates that reference it are not part of that check — they silently lose the reference (`registry` becomes null) instead of blocking the delete.",
    "method": "DELETE",
  ...
  },
  {
    ...
    "description": "Delete a template permanently. Verify with get-template first; a template referenced by a live endpoint should not be deleted.",
    "method": "DELETE",
  ...
  },
  {
    ...
    "description": "Get a cluster. Returns a single cluster by ID. The pods field is an aggregate summary (total + count by status); fetch the member pods themselves from /v2/clusters/{id}/pods.",
    "method": "GET",
    "path": "/v2/clusters/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "Get a CPU type. Returns a single CPU type with pricing. Availability details are included only when requested with include=AVAILABILITY, which requires `product` — stock differs by product context.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get a data center. Returns a single data center. Availability is included only when requested with include=GPU_AVAILABILITY or include=CPU_AVAILABILITY.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get a serverless endpoint. Returns a single serverless endpoint by ID.",
    "method": "GET",
    "path": "/v2/serverless/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "Get a GPU type. Returns a single GPU type with pricing. Availability details are included only when requested with include=AVAILABILITY, which requires `product` — stock differs by product context.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get a container registry credential. Returns a single container registry credential by ID. `username` and `password` are never included in the response — credentials are write-only, matching `createRegistry`.",
    "method": "GET",
    "path": "/v2/registries/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "List registered SSH public keys. Returns the account's registered SSH public keys — the keys provisioned into pods created with `startSsh` and used to authenticate the SSH connections reported in a pod's `ssh` block.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get a template. Returns the full configuration of a single template by ID. Serves both templates you own and public catalog templates — everything you can read. Updates and deletes remain restricted to templates you own.",
    "method": "GET",
    "path": "/v2/templates/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "List a cluster's pods. Returns the full member pods of a cluster. The cluster summary (`GET /v2/clusters/{id}`) carries only aggregate pod counts; this endpoint returns each member as a complete Pod object.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "List clusters. Returns all clusters owned by the authenticated user.",
    "method": "GET",
    "path": "/v2/clusters",
    "params": [],
    "hasBody": false,
  ...
  },
  {
    ...
    "description": "List CPU types. Returns available CPU flavors. Availability is included only when requested with include=AVAILABILITY, which requires `product` — stock differs by product context.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "List data centers. Returns available data center locations with region, compliance, supported network volume tiers, and global networking support. Use include=GPU_AVAILABILITY or include=CPU_AVAILABILITY to add per-resource availability arrays to each data center. The regions, networkVolumeTypes, compliance, and globalNetwork query parameters filter the list before it is returned.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get public endpoint billing history. Returns Runpod public endpoint billing history for the authenticated user, split into time buckets by startTime/endTime with bucketSize or by lastN recent buckets. Each record reports the endpoint total for one bucket, and metadata echoes the resolved query window, record count, and total endpoint amount across all returned records.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "List serverless endpoint releases. Returns the endpoint's release history (newest first) plus a rollout summary of how many workers are running the current version. Each release is a versioned configuration snapshot with a `diff` of what changed; build-driven releases carry a `buildId` (fetch build detail via the builds sub-routes).",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "List GPU types. Returns available GPU types with pricing. Availability is included only when requested with include=AVAILABILITY, which requires `product` — stock differs by product context. With countryCodes, the list is narrowed to GPU types deployable in those countries, so \"this geography + this chip\" resolves in one read.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "List network volumes. Returns all network volumes owned by the authenticated user.",
    "method": "GET",
    "path": "/v2/network-volumes",
    "params": [],
    "hasBody": false,
  ...
  },
  {
    ...
    "description": "List pods. Returns pods owned by the authenticated user. Cluster member pods are excluded by default; set `includeClusterPods=true` to include them (each carries a non-null `cluster` membership block).",
    "method": "GET",
    "path": "/v2/pods",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "List container registries. Returns all container registry credentials owned by the authenticated user.",
    "method": "GET",
    "path": "/v2/registries",
    "params": [],
    "hasBody": false,
  ...
  },
  {
    ...
    "description": "Get serverless billing history, split into time buckets. SIZE WARNING: with defaults this emits one record per endpoint PER BUCKET — on an account with many endpoints the response overflows the tool-result limit and becomes unusable. Always pass lastN: 1 (or a bucketSize spanning the whole window) for one record per endpoint, and serverlessId when you need one endpoint. Distinct from pod billing, which covers standalone pods.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Rename a cluster. Renames a cluster. This endpoint only changes the cluster name — compute shape, type, and container configuration are fixed at creation and cannot be updated.",
    "method": "PATCH",
    "path": "/v2/clusters/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "Update a network volume. Updates mutable fields on a network volume. Only provided fields are changed. Note: `size` may only increase; attempts to reduce size will be rejected.",
    "method": "PATCH",
    "path": "/v2/network-volumes/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "Replace registered SSH public keys. Replaces the account's full set of registered SSH public keys. Existing keys not present in the request are removed; send `[]` to remove all keys. Keys take effect for pods created afterwards with `startSsh` — running pods are not updated.",
    "method": "PUT",
    "path": "/v2/account/ssh-keys",
    "params": [],
    "hasBody": true,
