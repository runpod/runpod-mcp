...
export const generatedTools: GeneratedTool[] = [
        ...
        "QueueDelayScaling": {
          ...
          "properties": {
            "type": {
              ...
              "x-enum-varnames": [
                "QueueDelayScalingTypeQueueDelay"
              ],
              "enum": [
                "QUEUE_DELAY"
              ]
        ...
        "RequestCountScaling": {
          ...
          "properties": {
            "type": {
              ...
              "x-enum-varnames": [
                "RequestCountScalingTypeRequestCount"
              ],
              "enum": [
                "REQUEST_COUNT"
              ]
  ...
  },
  {
    ...
    "description": "Create a template. Creates a reusable container-configuration preset — image, disk, ports, env, registry, and mount settings — for pods and serverless endpoints. `createPod` and `createEndpoint` don't take a template ID; instead, spread a template's fields into the request body directly. Returns the created template.",
    "method": "POST",
    "path": "/v2/templates",
    "params": [],
    "hasBody": true,
  ...
  },
  {
    ...
    "description": "Get a CPU type. Returns a single CPU type with pricing. Availability details are included only when requested with include=AVAILABILITY.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get a GPU type. Returns a single GPU type with pricing. Availability details are included only when requested with include=AVAILABILITY.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "Get a template. Returns the full configuration of a single template by ID.",
    "method": "GET",
    "path": "/v2/templates/{id}",
    "params": [
      {
  ...
  },
  {
    ...
    "description": "List CPU types. Returns available CPU flavors. Availability is included only when requested with include=AVAILABILITY.",
    "method": "GET",
  ...
  },
  {
    ...
    "description": "List GPU types. Returns available GPU types with pricing. Availability is included only when requested with include=AVAILABILITY.",
    "method": "GET",
